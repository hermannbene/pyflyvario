...
# 0x27: pressure/temperature oversampling rate = 1, normal mode, optimized for paragliding variometer        
bus.write_byte_data(BMP280ADDR, 0xF4, 0x8F)

# select configuration register, 0xF5
# 0xA0: standby time = 1000 ms
bus.write_byte_data(BMP280ADDR, 0xF5, 0x18)
...
#    print("Pressure NN: %.2f Pa " %pressure_nn)
    return pressure
